...
import { checkName, checkCode, checkDate,checkNationality ,checkBio} from "../../validation/addAuthorValidations";
...
function AddAuthors() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (nameError === null && codeError === null && dateError === null) {
      setIsLoading(true);
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={handleChange}
                  onKeyUp={(event) => {
                    setCodeError(checkCode(event.target.value));
                  }}
                  className="w-full px-3 py-2 text-gray-900 bg-gray-100 rounded-md"
                />
                {codeError ? (
                ...
                <div className="relative">
                  ...
                  <div className="absolute  inset-0  flex justify-center items-center z-50">
                    <div className=" rounded-full h-20 w-20  ">
                      <img src={spinner} className="w-50 h-auto" />
                    </div>
                  </div>{" "}
                </div>
              )}
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  onKeyUp={event => setBioError(checkBio(event.target.value))}
                  className="w-full px-3 py-2 text-gray-900 bg-gray-100 rounded-md"
                />
                 {bioError ? (
